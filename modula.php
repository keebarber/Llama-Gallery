<?php
/**
 * Plugin Name: Modula by Valorous Circle
 * Plugin URI: https://wp-modula.com/
 * Description: Modula is one of the best & most creative WordPress gallery plugins. Use it to create a great grid or masonry image gallery. Now modified by Valorous Circle!
 * Author: Macho Themes & Valorous Circle
 * Version: 1.4.1
 * URI: https://www.machothemes.com/
 */

define( 'MODULA_VERSION', '1.4.1' );
...
$updateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://github.com/TeamValorous/modula/',
	__FILE__,
	'modula'
);
...
$updateChecker->setAuthentication('5b1cdae6fe5ef2cfe93f8e169194bcfbf0f2ae7a');
